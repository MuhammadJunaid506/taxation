    ...
    <section className="py-16 bg-gray-100 w-full">
      <div className="container mx-auto px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">We'd love to hear from you. Please fill out the form below and we'll get back to you as soon as possible.</p>
        </div>
        <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center">
              <button
                type="submit"
                className="w-full md:w-auto px-6 py-3 bg-[#111827] text-white font-semibold rounded-lg hover:bg-gray-500 transition duration-200"
              >
                Send Message
              </button>
            </div>
