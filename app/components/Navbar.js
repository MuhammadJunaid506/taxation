const Navbar = () => {
    return (
      <nav className="w-full bg-gray-800 p-6 text-white flex justify-between">
        ...
        <div>
          ...
          <a href="/login" className="px-4 border bg-slate-50 text-black rounded-full py-2">Get Started</a>
        </div>
      </nav>
    );
  };
